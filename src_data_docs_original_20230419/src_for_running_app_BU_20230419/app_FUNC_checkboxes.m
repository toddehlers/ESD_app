...
%------------------------------------------------------------------------
% This function gets is responsibel for turning on and off the check boxes
% based on any change
...
% This function uses the following functions
    ...
    %1-FUNC_mapcategoryEN
    %2-FUNC_mapcategoryVAL
    %3-FUNC_mapatEN
    %4-FUNC_FUNC_mapatENce
    %5-FUNC_mapatVAL
    %6-FUNC_FUNC_mapatVALce
    %7-FUNC_mapextraEN
    %8-FUNC_mapextraVAL
    %9-FUNC_plthistEN
    %10-FUNC_plthistVAL
    %11-FUNC_MapCounter
    %12-FUNC_profilecategoryEN
    %13-FUNC_profilecategoryVAL
    %14-FUNC_profilestatEN
    %15-FUNC_profilestatVAL
    %16-FUNC_profilesmplEN
    %17-FUNC_profilesmplVAL
    %18-FUNC_profileallEN
    %19-FUNC_profileallVAL
    %20-FUNC_profilecordEN
    %21-FUNC_profilecordVAL
    %22-FUNC_ProfileCounter
    %23-FUNC_precEN
    %24-FUNC_precVAL
    %25-FUNC_PrecipitationCounter
    %26-FUNC_TemperatureCounter
    %27-FUNC_histcounter
...
% -------------------------------------------------------------
    ...
    N_precipitaion = FUNC_PrecipitationCounter(app,PrecMap,precHOW,prec,difprec);
    N_temperature = FUNC_TemperatureCounter(app,TempMap,precHOW,prec,difprec);
% -------------------------------------------------------------
    if n_data > 0
        FUNC_plthistEN(app,'on')
    else
...
% -------------------------------------------------------------
    if (N_map + N_profile + N_precipitaion + N_temperature + N_histogram) > 0
...
function N_precipitaion = FUNC_PrecipitationCounter(app,PrecMap,precHOW,prec,difprec)
    A = sum(prec == 1); % number of checkboxes for precipitation map
    A1 = A*precHOW(1);
    if A1 > 1
        A1 = 1;
    end
...
function N_temperature = FUNC_TemperatureCounter(app,TempMap,precHOW,prec,difprec)
    A = sum(prec == 1);
    A1 = A*precHOW(1);
    if A1 > 1
        A1 = 1;
    ...
    N_temperature = precfig + difprecfig;
    
    if TempMap == 1
        app.totaltemperature.Value = N_temperature;
    else
        app.totaltemperature.Value = 0;
    end
end
%%
