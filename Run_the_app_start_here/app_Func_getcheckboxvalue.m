...
%------------------------------------------------------------------------
% This function gets all the check boxe values after each change
% The input is the app object and the outputs get stored directly to the
% app object
...
%% None Erosion map panel
        PrecMap = app.PrecipitationMap.Value;
        TempMap = app.TemperatureMap.Value;
        %----------------
...
%% add them to the app
        ...
        app.PrecMap = PrecMap ;              % choose precipitation map
        app.TempMap = TempMap ;              % choose temperature map
