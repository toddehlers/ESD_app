...
%         app_FUNC_waitbar(wb,prc,"Erosion Profile (saving...) " + string(round(prc*100,1))+" %")
...
%-----------------------------------------------
    if app.CategorizedButton.Value == 1
        temppath = string(ppath)+"\SavedFigures\ErosionProfiles\"+TPi+"_"+TPn+"\"...
